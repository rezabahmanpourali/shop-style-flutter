...
//   }
// }
// class SavedBarberShopsPage extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Consumer<GlobalController>(
//       builder: (context, globalController, child) {
//         final bookmarkedShops = globalController.bookmarkedShops;

//         return Scaffold(
//           appBar: AppBar(title: Text('Saved Barber Shops')),
//           body: bookmarkedShops.isEmpty
//               ? Center(child: Text('No Saved Barber Shops'))
//               : ListView.builder(
//                   itemCount: bookmarkedShops.length,
//                   itemBuilder: (context, index) {
//                     final shop = bookmarkedShops[index];
//                     return ListTile(
//                       leading: Image.network(shop.images![0].url.toString()),
//                       title: Text(shop.barberShopName.toString()),
//                       trailing: IconButton(
//                         icon: Icon(Icons.delete),
//                         onPressed: () {
//                           globalController.removeBookmark(shop);
//                         },
//                       ),
//                     );
//                   },
